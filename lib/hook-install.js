 ...
 *
 * Dois eventos, um par:
 *   - `Stop`         pede ao agente que grave o contexto da sessão.
 *   - `SessionStart` injeta o contexto gravado no início da conversa seguinte.
 *
 * Sem o segundo, o vault acumula conhecimento que ninguém lê.
 *
...
/** Eventos que a Melinna instala, e o subcomando que cada um invoca. */
export const HOOK_EVENTS = [
  { event: "Stop", sub: "hook-run", purpose: "pede a gravação do contexto ao fim da sessão" },
  { event: "SessionStart", sub: "hook-start", purpose: "carrega o contexto salvo no início da conversa" },
];
